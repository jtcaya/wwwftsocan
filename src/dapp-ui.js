                ...
                let html = `<tr style="border-top:1px solid #8f8f8f;border-bottom:1px solid #8f8f8f;padding: 5px 0;line-height:normal;">
                                <td style="padding: 5px 0;">
                                    <div style="display:flex;">
                                        <img style="width:30px;height:30px;margin:auto;" src="${dappUrlBaseAddr}assets/${validatorList[j].nodeId}.png" alt="${validatorList[j].name}"/>
                                        <div class="validator-table-row">
                                            ...
                                            <div class="wrapper-claim" style="margin:0;">
                                                <span class="address-claim" style="font-size: 10px;width: fit-content;margin:auto;">${validatorList[j].nodeId.slice(0, 12) + "..." + validatorList[j].nodeId.slice(-4)}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
