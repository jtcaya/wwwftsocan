...
class LandingController extends AggregateRootController implements AggregateEventListenerInterface
{
    const READ_REQUESTED = 'networks_read_received';

    // Define the Aggregate's invokable listeners.
    protected $aggregateListenerNames = [
        LandingController::READ_REQUESTED => NetworksReadModel::class,
    ];
    ...
    public function onDispatch(AscmvcEvent $event)
    {
        ...
        $this->view['css'][] = $baseConfig['URLBASEADDR'] . 'css/landing-page.css';

        $this->view['js'][] = $baseConfig['URLBASEADDR'] . 'js/web3.min.js';
//        $this->view['js'][] = $baseConfig['URLBASEADDR'] . 'js/avalanche.js';
    }
    ...
    public function preIndexAction($vars = null)
    {
        ...
        $event = new AggregateEvent(
            ...
            LandingController::READ_REQUESTED
        );
    ...
    public function indexAction($vars = null)
    {
        ...
        $this->view['templatefile'] = 'landing_index';
